...
namespace NBarCodes {
  ...
  /// </summary>
  sealed class ImageBuilder : IBarCodeBuilder, IDisposable {
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2213:DisposableFieldsShouldBeDisposed", MessageId = "_barCodeImage")]
    public void Dispose() {
      _drawFormat.Dispose();
      _drawFormat = null;
    }
    ...
    /// desirable dimensions, trimming to reasonable defaults if
    /// necessary.
    /// </summary>
    ...
    public void Prepare(float width, float height) {
      if (_barCodeImage != null) {
        throw new InvalidOperationException("Image is already being built!");
      }
    ...
    public Bitmap GetImage() {
      // leave the disposing of the generated image to the caller
      var result = _barCodeImage;
      _barCodeImage = null;
      return result;
    }
